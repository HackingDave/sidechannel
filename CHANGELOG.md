...
### Changed
- README: Added `/diagnose` command to System commands reference
- README: Documented startup ready notification behavior
- README: Documented device name prompt during install and `--help` flag
